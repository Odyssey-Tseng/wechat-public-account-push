export const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wxb463adbda9735e99",
  
  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "9e93a2cf403c2473e7c1de34a3b2688f",
  ...
  USERS: [
    {
      ...
      id: "oNFZF6tOrZOiKkSWUTiA5d49v2us",
      // 你想对他发送的模板消息的模板ID
      ...
      openUrl: "https://weibo.com/peanut013",
      ...
      festivals: [
       ...
       //{"type": "生日", "name": "周同学", "year": "1998", "date": "06-27"}
        ...
        {"type": "节日", "name": "上海市考", "year": "2022", "date": "12-11"},
        {"type": "节日", "name": "浙江选调", "year": "2022", "date": "12-18"},
      ],
  ...
  CALLBACK_TEMPLATE_ID: "Ns0NXzwOPxpYszVM64nikYeT7gTQ_k7ta-cbcaUCy9Y",
